          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 30px; color: #555555; font-size: 15px; line-height: 1.6;">
                Gracias por registrarte en <strong>Emigrantes FT</strong>. Para completar tu registro, por favor verifica tu correo electrónico usando el siguiente código:
              </p>
          ...
          <tr>
            <td style="background-color: #f8f9fa; padding: 30px; text-align: center; border-top: 1px solid #e9ecef;">
              ...
              <p style="margin: 0; color: #6c757d; font-size: 13px;">
                Servicios de POA y financieros para emigrantes
              </p>
